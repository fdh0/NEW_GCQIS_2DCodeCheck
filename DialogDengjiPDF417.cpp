...
CDialogDengjiPdf417::CDialogDengjiPdf417(CWnd* pParent /*=NULL*/)
	: CBCGPDialog(CDialogDengjiPdf417::IDD, pParent)
{
...
void CDialogDengjiPdf417::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CDialogDengjiPdf417, CBCGPDialog)
	...
	//}}AFX_MSG_MAP
	ON_BN_CLICKED(IDOK, &CDialogDengjiPdf417::OnBnClickedOk)
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CDialogDengji message handlers

void CDialogDengjiPdf417::OnCheck1() 
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE);
	if (m_bDJ1&&m_bDJ2&&m_bDJ3
		&&m_bDJ4&&m_bDJ5&&m_bDJ6) 
	{
		m_bCheckAll = TRUE;
	}
	else
...
void CDialogDengjiPdf417::OnCheck2() 
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE);
	if (m_bDJ1&&m_bDJ2&&m_bDJ3
...
void CDialogDengjiPdf417::OnCheck3() 
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE);
	if (m_bDJ1&&m_bDJ2&&m_bDJ3
...
void CDialogDengjiPdf417::OnCheck4() 
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE);
	if (m_bDJ1&&m_bDJ2&&m_bDJ3
...
void CDialogDengjiPdf417::OnCheck5() 
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE);
	if (m_bDJ1&&m_bDJ2&&m_bDJ3
...
void CDialogDengjiPdf417::OnCheck6() 
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE);
	if (m_bDJ1&&m_bDJ2&&m_bDJ3
...
//void CDialogDengjiPdf417::OnCheck7() 
//{
//	// TODO: Add your control notification handler code here
//	UpdateData(TRUE);
//	if (m_bDJ1&&m_bDJ2&&m_bDJ3
...
void CDialogDengjiPdf417::OnCheckAll() 
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE);
	if (m_bCheckAll)
...
void CDialogDengjiPdf417::OnCheckNoall() 
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE);
	if (m_bNoAll)
...
BOOL CDialogDengjiPdf417::OnInitDialog() 
{
...
void CDialogDengjiPdf417::OnBnClickedOk()
{
	// TODO: 在此添加控件通知处理程序代码
	CBCGPDialog::OnOK();
}
