#if !defined(AFX_DIALOGDENGJI2006_H__2D97BA22_0FC0_4B68_98D6_4D4836AFA0A9__INCLUDED_)
#define AFX_DIALOGDENGJI2006_H__2D97BA22_0FC0_4B68_98D6_4D4836AFA0A9__INCLUDED_
...
class CDialogDengji2006 : public CBCGPDialog
{
// Construction
public:
	CDialogDengji2006(CWnd* pParent = NULL);   // standard constructor

// Dialog Data
	//{{AFX_DATA(CDialogDengji)
	enum { IDD = IDD_DIALOG_AIMDRM2006 };
	BOOL	m_bDJ1;
	BOOL	m_bDJ2;
	BOOL	m_bDJ3;
	BOOL	m_bDJ4;
